class TransporterUpdateStrings {
  static const Map<String, Map<String, String>> _strings = {
    ...
    'rc_book': {'en': 'RC Book', 'mr': 'आर.सी. बुक (वाहन नोंदणी प्रमाणपत्र)'},
    'driving_license': {'en': 'Driving License', 'mr': 'वाहन चालक परवाना'},
    ...
    // Button
    'save_update': {'en': 'Save & Update Details', 'mr': 'तपशील जतन करा'},
    'updating': {'en': 'Updating...', 'mr': 'अपडेट होत आहे...'},
    ...
    'no_changes': {'en': 'No changes to update', 'mr': 'अपडेट करण्यासाठी कोणतेही बदल नाहीत'},
    ...
    // RC validation
    'rc_format_error': {'en': 'Invalid vehicle number (e.g. KA01AB1234)', 'mr': 'अवैध वाहन क्रमांक (उदा. KA01AB1234)'},

    // DL validation
    'dl_format_error': {'en': 'Invalid DL format (e.g. KA0120201234567)', 'mr': 'अवैध डीएल स्वरूप (उदा. KA0120201234567)'},
    ...
    // Helper texts
    'rc_helper': {'en': 'Format: KA01AB1234', 'mr': 'स्वरूप: KA01AB1234'},
    'dl_helper': {'en': 'Format: KA0120201234567', 'mr': 'स्वरूप: KA0120201234567'},
